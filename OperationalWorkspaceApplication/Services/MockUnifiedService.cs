    ...
    public async Task<EmailContextDto?> GetEmailContextAsync(string emailId)
    {
        var email =
            new EmailInsightDto
            {
                ...
                Message =
                    "Please review outstanding system configurations for transaction reference token ORD-MOCK-7721 immediately.",

                BusinessPartnerId = 9912,

                BusinessPartnerName =
                    "Mock Unified Testing Corporation",
                ...
                SenderEmail =
                    "client-operator@postmantesting.com",

                SenderName =
                    "Mock Unified Testing Corporation",

                To =
                    "addin-operator@enterprise-domain.com",
